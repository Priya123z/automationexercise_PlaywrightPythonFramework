...
# ========================================================================
# This file provides:
# 1.a. To start the browser window maximized (added by Priya)
...
#1. a. To start the browser window maximized
...
def pytest_addoption(parser):
    ...
    parser.addoption("--base-url", default="https://automationexercise.com/", help="Base URL for tests")
